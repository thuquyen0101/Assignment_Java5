        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="row p-4">
                        <div class="col-6">
                            <form action="/mau-sac/search">
                                <input placeholder="Nhập mã hoặc tên màu" name="keyword">
                                <button class="btn btn-success">Search</button>
                            </form>
                        </div>
                        <div class="col-6">
                            <a class="btn btn-success ml-5" href="/mau-sac/form-add">Thêm mới </a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Chắc chắn muốn xóa?')" class="btn btn-success"
                                           href="/mau-sac/remove/${x.id}">Remove </a>
                                        <a class="btn btn-success" href="/mau-sac/update?id=${x.id}">Update </a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <ul class="pagination">
                            <c:if test="${totalPage > 0}">
                                <c:if test="${currentPage > 0}">
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="/mau-sac/hien-thi?pageNumber=${currentPage - 1}">Previous</a>
                                    </li>
                                </c:if>
                                <c:if test="${currentPage == 0}">
                                ...
                                <c:forEach begin="0" end="${totalPage -1}" var="x">
                                    <li class="page-item"><a class="page-link"
                                                             href="/mau-sac/hien-thi?pageNumber=${x}">${x+1}</a></li>
                                </c:forEach>
                                <c:if test="${currentPage < (totalPage -1)}">
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="/mau-sac/hien-thi?pageNumber=${currentPage + 1}">Next</a>
                                    </li>
                                </c:if>
                                <c:if test="${currentPage == (totalPage -1)}">
                                    <li class="page-item disabled">
