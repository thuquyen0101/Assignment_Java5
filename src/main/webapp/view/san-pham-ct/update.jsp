    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <form action="/san-pham-ct/update" method="post" class="p-3">
                            ...
                            <div class="col-6">
                                ...
                                <select name="sanPham" class="p-1">
                                    ...
                                    <c:forEach items="${listSp}" var="x">
                                        <option value="${x.id}"
                                                <c:if test="${ms.sanPham.id == x.id}">selected</c:if>
                            ...
                            <div class="col-6">
                                ...
                                <select name="dongSanPham">
                                    ...
                                    <c:forEach items="${listDsp}" var="x">
                                        <option value="${x.id}"
                                                <c:if test="${ms.dongSanPham.id == x.id}">selected</c:if>
                            ...
                            <div class="col-6">
                                ...
                                <select name="mauSac">
                                    ...
                                    <c:forEach items="${listMS}" var="x">
                                        <option value="${x.id}"
                                                <c:if test="${ms.mauSac.id == x.id}">selected</c:if>
                                        >${x.ten}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="col-6">
                                ...
                                <select name="nhaSanXuat">
                                    ...
                                    <c:forEach items="${listNsx}" var="x">
                                        <option value="${x.id}"
                                                <c:if test="${ms.nhaSanXuat.id == x.id}">selected</c:if>
                                        >${x.ten}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        <button class="btn btn-success ml-2">UPDATE</button>
                    </form>
